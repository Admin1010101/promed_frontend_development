...
const PatientCard = ({
  ...
  const getIvrInitialData = () => {
    console.group("🔍 IVR Initial Data Debug");
    console.log("📦 Full user object:", user);
    console.log("📦 Provider data being sent:", {
      facility: user?.user?.facility || user?.facility,
      city: user?.user?.city || user?.city,
      state: user?.user?.state || user?.state,
      country: user?.user?.country || user?.country,
      facility_phone: user?.user?.facility_phone_number || user?.facility_phone_number,
      phone: user?.user?.phone_number || user?.phone_number,
    });
    console.groupEnd();
